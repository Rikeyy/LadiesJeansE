      ...
      <div data-aos="flip-up" class="glass left-[20%] top-[10%] absolute w-3/5 h-4/5 text-white max-lg:h-3/5 max-lg:w-4/5 max-lg:left-[10%] max-lg:top-[20%]">
        <div class="flex h-full rounded-[50px]">
          <form @submit.prevent="submitForm" class="w-3/5 rounded-l-[50px] text-white text-center m-auto max-lg:w-full ">
            <h1 class="text-6xl max-md:text-4xl font-medium pb-6 max-md:pt-5 max-md:pb-3">Hi! <span class="text-6xl max-md:text-4xl font-medium text-sky-500">Selamat Datang</span></h1>
            <h2 class="text-3xl max-md:text-xl font-light pb-10 max-md:pb-5">Log Masuk Sebagai <span class="text-4xl max-md:text-2xl font-medium text-sky-500">Pekerja</span></h2>
            <p class="text-xl font-light pb-3" for="">ID<span class="text-xl  font-medium text-sky-500"> Pekerja</span></p> 
            <input class="shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] rounded-full w-[45%] text-center max-md:w-[60%] bg-transparent border-2 border-sky-500 px-3 py-1" type="text" v-model="idPekerja" placeholder="ID Pekerja" >
            <p class="text-xl font-light pb-3 pt-6 max-md:pt-4" for="">Kata<span class="text-xl font-medium text-sky-500"> Laluan</span></p> 
            <input class="shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] rounded-full w-[45%] text-center max-md:w-[60%] bg-transparent border-2 border-sky-500 px-3 py-1" type="password" v-model="password" placeholder="Kata Laluan Pekerja"> <br><br>
            <button type="submit" class="text-white bg-gradient-to-r w-[45%] max-md:w-auto max-md:mb-5 from-sky-500 to-indigo-500 h-12 px-12 rounded-full my-auto shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)]">Log Masuk</button>
          </form>
