            ...
            <div class="flex justify-between mt-[2%]">
                <div data-aos="flip-up" data-aos-duration="1500" class="bg-white w-[90%] h-[78%] white pt-[5%] pb-[7%]">
                    ...
                    <form class="w-[80%] m-auto" @submit.prevent="submitForm">
                        ...
                        <div class="relative z-0 w-[45%] mb-6 group">
                            <input type="text" name="floating_role" id="floating_role"  v-model="worker.Peranan_Pekerja" class="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-[45%] mb-6 group">
                            <input type="gaji" name="floating_gaji" id="floating_gaji"  v-model="worker.Gaji_Pekerja" class="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
