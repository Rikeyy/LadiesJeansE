    ...
    <form class="w-[80%] m-auto" @submit.prevent="submitForm">
        <div class="flex justify-around">
            <div class="relative z-0 w-[45%] mb-6 group m-auto">
                <input type="text" name="floating_IDPromosi" v-model="IDPromosi" id="floating_IDPromosi" class="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="relative z-0 w-[45%] mb-6 group m-auto">
                <input type="text" name="floating_NamaPromosi" id="floating_NamaPromosi" v-model="NamaPromosi" class="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="flex justify-around">
            ...
            <div class="relative z-0 w-[15%] mb-6 group m-auto">
                <input type="text" name="floating_HargaPromosi" id="floating_HargaPromosi" v-model="HargaPromosi" class="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="flex justify-center">
            ...
            <div class="relative z-0 w-[45%] group m-auto flex">
                <label for="items" class="pt-3 pr-3">Pilih Status Promosi:</label>
                    <select id="items" v-model="selectedStatus" class="block mt-2 appearance-none w-[50%] bg-gray-200 border border-gray-200 text-gray-700 py-[6PX] px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"> 
                        <option disabled>-Select Item-</option>
